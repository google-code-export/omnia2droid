static int omnia_II_init_gpio_table[][6] = {
	...
	/* GPF */
	{ GPIO_CAM_MCLK, 1, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE },
...
#ifdef GPIO_KBR3
        { GPIO_KBR3, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#ifdef GPIO_KBR4
        { GPIO_KBR4, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#ifdef GPIO_KBR5
        { GPIO_KBR5, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#ifdef GPIO_KBR6
        { GPIO_KBR6, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#endif
	{ GPIO_FM_nRST, GPIO_FM_nRST_AF, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 }, 
#ifdef GPIO_CAM_CIF_nRST
...
//	{ GPIO_MSENSE_RST, GPIO_MSENSE_RST_AF, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 }, // bss 
	...
	{ GPIO_KBC2, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 }, 
#ifdef GPIO_KBC3
        { GPIO_KBC3, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#ifdef GPIO_KBC4
        { GPIO_KBC4, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#ifdef GPIO_KBC5
        { GPIO_KBC5, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#ifdef GPIO_KBC6
        { GPIO_KBC6, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#ifdef GPIO_KBC7
        { GPIO_KBC7, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE, 0, 0 },
#endif
#ifdef GPIO_PHONE_ON
